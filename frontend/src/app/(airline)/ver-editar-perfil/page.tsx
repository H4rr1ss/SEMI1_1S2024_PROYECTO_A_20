...
import {
  ...
  newClient,
  changePhoto,
} from "@/utils/functions/ver-editar-perfil.funcs";
...
export default function ViewEditProfile() {
  ...
  useEffect(() => {
    ...
    setProfilePic(client.profilePicture);
  }, [clientStore]);
      ...
      <div className="editProfile mt-10 w-3/5 flex flex-col items-center ">
        <div className="h-1/2 w-full flex justify-center mb-4 mt-4">
          <div className="w-2/5 flex flex-col justify-center items-center gap-y-1 ml-5">
            ...
            <input
              ...
              style={{ display: "none" }}
              onChange={(event) => {
                changePhoto(event, setProfilePic);
              }}
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon-svg icon icon-tabler icon-tabler-settings-filled"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              stroke-width="1"
          ...
          <div className="w-3/5 flex flex-col justify-center items-center gap-y-8">
            <div className="flex items-center gap-x-1">
              <InputProfile
                ...
                text="Nombre"
                value={name}
                disabled={handleDisabled("name", selectedSVG)}
                setInfo={setName}
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center gap-x-1">
              <InputProfile
                ...
                text="Apellido"
                value={lastName}
                disabled={handleDisabled("lastName", selectedSVG)}
                setInfo={setLastName}
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center gap-x-1">
              <InputProfile
                ...
                value={email}
                disabled={handleDisabled("email", selectedSVG)}
                setInfo={setEmail}
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="flex items-center gap-x-1">
          <InputProfile
            ...
            disabled={handleDisabled("passportNumber", selectedSVG)}
            setInfo={setPassportNumber}
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="icon-svg icon icon-tabler icon-tabler-settings-filled"
        ...
        <div className="w-full flex justify-evenly mt-10 mb-10">
          <div className="flex items-center gap-x-1">
            <InputProfile
              ...
              disabled={handleDisabled("phoneNumber", selectedSVG)}
              setInfo={setPhone}
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex items-center gap-x-1">
            <InputProfile
              ...
              text="Nacionalidad"
              value={nationality}
              disabled={handleDisabled("nationality", selectedSVG)}
              setInfo={setNationality}
            />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon-svg icon icon-tabler icon-tabler-settings-filled"
