  ...
  return (
    <div className="flex-grow">
      ...
      <div className="other-options text-black mt-10">
        <h1 className="text-initial text-center">
          Vuela Más por Menos: Vuelos Baratos
        </h1>
        ...
        <div className="about-kehuel text-center">
          <h3>
            Personaliza tu viaje y disfruta de las mejores ofertas de vuelos
          </h3>
          <p>
            Personaliza fácilmente tus planes de viaje, y aprovéchate de las
            opciones más útiles de Kehuel como alertas de precios de vuelos,
            calendario de ofertas y ofertas de reserva anticipada. El sistema de
            pago seguro de Kehuel te ofrece las opciones de pago más seguras y
            sencillas, incluido el pago con tarjeta de crédito y débito.
          </p>
          <h3>
            Conozca más sobre nuestra historia, nuestro negocio y nuestras
            iniciativas de sostenibilidad.
          </h3>
          <p>
            Kehuel conecta el mundo hacia y a través de nuestro centro global en
            Guatemala. Operamos aviones modernos, eficientes y cómodos, y
            nuestra fuerza laboral culturalmente diversa ofrece servicios
            galardonados a nuestros clientes en seis continentes todos los días.
          </p>
        </div>
      </div>
    </div>
