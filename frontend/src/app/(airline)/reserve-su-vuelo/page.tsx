            ...
            <div className="flex flex-col items-center">
              ...
              <div className="selectPassengers mt-4 w-5/6 h-48 flex flex-col justify-center items-center">
                ...
                <div className="w-full flex justify-evenly">
                  <div className="rv-input-reserve flex">
                    ...
                    <div className="flex items-center">
                      <button
                        className="px-3 py-1 bg-gray-300 text-gray-700 rounded-l focus:outline-none"
                        onClick={() =>
                          adults > 1 ? setAdults(adults - 1) : null
                        }
                      >
                        -
                      </button>
                      <input
                        type="text"
                        className="w-16 px-2 py-1 bg-white text-gray-700 border border-gray-400 rounded-none focus:outline-none text-center"
                        value={adults}
                      />
                      <button
                        className="px-3 py-1 bg-gray-200 text-gray-700 rounded-r focus:outline-none"
                        onClick={() => {
                          setAdults(adults + 1);
                        }}
                      >
                ...
                <div className="w-full flex mt-8 justify-evenly">
                  <InputReserve
                    text="Bebés(menores de dos años)"
                    value={babies}
                    setValue={setBabies}
                  />
                  <InputReserve
                    text="Niños(de 5 a 11 años)"
                    value={children}
