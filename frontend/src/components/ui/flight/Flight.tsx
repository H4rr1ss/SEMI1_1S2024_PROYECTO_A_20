...
const Flight = (props: FlightProps) => {
  ...
  const handleClick = () => {
    ...
    props.sets.setIdFlight(props.id);
    props.sets.setPrice(newPrice);
    props.sets.setIndexFlight(props.index);
    console.log("Vuelo seleccionado: ", props.id);
    console.log("Precio final del vuelo: ", newPrice);
    console.log("Index del vuelo: ", props.index);
  };
  ...
  return (
    <div
      className={`f-info bg-gray-100 w-full h-32 ${isPressed ? "pressed" : ""}`}
      onClick={handleClick}
    >
